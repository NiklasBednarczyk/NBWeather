...
import de.niklasbednarczyk.nbweather.test.common.utils.assertListDoesNotContain
import de.niklasbednarczyk.nbweather.test.common.utils.assertListHasSize
import de.niklasbednarczyk.nbweather.test.common.utils.assertListIsNotEmpty
import de.niklasbednarczyk.nbweather.test.common.utils.assertListsContainsItemInOrder
...
class GeocodingDaoTest : NBDaoTest<DatabaseGeocoding, GeocodingDao>() {

    override val databaseClass: Class<DatabaseGeocoding> = DatabaseGeocoding::class.java

    override fun initiateDao(): GeocodingDao = db.geocodingDao()
    ...
    fun getLocation_shouldFindLocationByCoordinates() {
        testGetItemQuery(
            ...
            insert = dao::insertLocation,
            createAct = { key ->
                dao.getLocation(key, key)
            },
    ...
    fun getVisitedLocations_shouldOnlyContainLocationsWithTimestampInOrder() =
        runTest {
            ...
            // Act
            val locations = dao.getVisitedLocations().firstOrNull()
    ...
    fun getCurrentLocation_shouldBeLocationWithHighestTimestamp() = runTest {
        ...
        dao.insertLocations(listOf(location1, location2, location3))

        // Act
        val currentLocation = dao.getCurrentLocation().firstOrNull()
