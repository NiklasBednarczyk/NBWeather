...
val ThemeTypeData.displayText: OwmString
    get() {
        val resId = when (this) {
...
val ColorSchemeTypeData.displayText: OwmString
    get() {
        val resId = when (this) {
...
val OwmLanguageType.displayText: OwmString
    get() {
        val resId = when (this) {
...
val OwmUnitsType.displayText: OwmString
    get() {
        val resId = when (this) {
...
val OwmTimeFormatType.displayText: OwmString
    get() {
        val resId = when (this) {
